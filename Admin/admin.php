...
// ── Helper: safely get count from any table ──
...
// ── Stats ──
$totalStudents    = safeCount($conn, 'Users') - 1; // exclude admin(s)
$totalQuestions   = safeCount($conn, 'Questions');
$totalCareers     = safeCount($conn, 'Careers');
$totalAssessments = safeCount($conn, 'Assessments'); // safe even if missing
...
if (!$recentStudents) $recentStudents = null;

// ── Top career matches ──
$topCareers = null;
// Check if Recommendations and Careers exist
  ...
  <div class="admin-content">
    ...
    <div class="two-col">
      ...
      <div class="admin-card">
        <div class="card-header">
          ...
          <a href="manage-users.php" class="btn-link">View All →</a>
        </div>
      ...
      <div class="admin-card">
        <div class="card-header">
          ...
          <a href="reports.php" class="btn-link">Full Report →</a>
        </div>
    ...
    <div class="admin-card">
      ...
      <div class="quick-grid">
        <a href="manage-users.php" class="quick-card"><i class="fa-solid fa-users"></i><span>Manage Students</span></a>
        <a href="manage-questions.php" class="quick-card"><i class="fa-solid fa-clipboard-question"></i><span>Assessment Questions</span></a>
        <a href="manage-careers.php" class="quick-card"><i class="fa-solid fa-briefcase"></i><span>Career Data</span></a>
        <a href="reports.php" class="quick-card"><i class="fa-solid fa-chart-bar"></i><span>View Reports</span></a>
      </div>
    </div>
